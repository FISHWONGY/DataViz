...
```{r}
protest <- read_csv(
  "/Volumes/My Passport for Mac/R/Protest/protest.csv", na = "NULL")
```
...
w_map  / (sum_bar | eu_map) +
  ggsave("/Volumes/My Passport for Mac/R/Protest/photo/ProtestSum_patch.png", dpi = 320, width = 13.8, height = 12)
```
...
res_bar  / (acco_parti_bar | parti_bar) +
  ggsave("/Volumes/My Passport for Mac/R/Protest/photo/PartiBar_patch.png", dpi = 320, width = 13.8, height = 12)
```
...
# patchwork
cn_bar  / year_bar +
  ggsave("/Volumes/My Passport for Mac/R/Protest/photo/BarChart_patch.png", dpi = 320, width = 13.8, height = 12)
```
